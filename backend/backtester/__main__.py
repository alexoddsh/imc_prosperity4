...
def version_callback(value: bool) -> None:
    if value:
        print(f"backtesterx {metadata.version('backtesterx')}")
        sys.exit(0)
...
def cli(
    ...
    data: Annotated[Optional[Path], Option(help="Path to data directory. Must look similar in structure to https://github.com/Xeeshan85/imc-prosperity-4-backtester/tree/main/backtester/resources.", show_default=False, exists=True, file_okay=False, dir_okay=True, resolve_path=True)] = None,
